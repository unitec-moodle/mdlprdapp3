 ...
 *
 * @module     theme_boost_bld_const/form-display-errors
...
define(['jquery', 'core/event'], function($, Event) {
    return {
        enhance: function(elementid) {
            ...
            if (form && !('boost_bld_constFormErrorsEnhanced' in form.dataset)) {
                ...
                form.dataset.boost_bld_constFormErrorsEnhanced = 1;
            }
        }
    };
});
