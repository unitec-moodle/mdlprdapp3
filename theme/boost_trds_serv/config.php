...
$THEME->scss = function($theme) {
    return theme_boost_trds_serv_get_main_scss_content($theme);
};
...
$THEME->extrascsscallback = 'theme_boost_trds_serv_get_extra_scss';
$THEME->prescsscallback = 'theme_boost_trds_serv_get_pre_scss';
$THEME->precompiledcsscallback = 'theme_boost_trds_serv_get_precompiled_css';
