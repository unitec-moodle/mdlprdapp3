...
/**
 * Privacy Subsystem implementation for theme_boost_trds_serv.
 *
...
namespace theme_boost_trds_serv\privacy;
...
/**
 * The boost_trds_serv theme stores a user preference data.
 *
 * @copyright  2018 Andrew Nicols <andrew@nicols.co.uk>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class provider implements
    ...
    public static function export_user_preferences(int $userid) {
        ...
        if (isset($draweropennavpref)) {
            $preferencestring = get_string('privacy:drawernavclosed', 'theme_boost_trds_serv');
            if ($draweropennavpref == 'true') {
                $preferencestring = get_string('privacy:drawernavopen', 'theme_boost_trds_serv');
            }
            \core_privacy\local\request\writer::export_user_preference(
                'theme_boost_trds_serv',
