 ...
 *
 * @module     theme_boost_trds_serv/form-display-errors
...
define(['jquery', 'core/event'], function($, Event) {
    return {
        enhance: function(elementid) {
            ...
            if (form && !('boost_trds_servFormErrorsEnhanced' in form.dataset)) {
                ...
                form.dataset.boost_trds_servFormErrorsEnhanced = 1;
            }
        }
    };
});
