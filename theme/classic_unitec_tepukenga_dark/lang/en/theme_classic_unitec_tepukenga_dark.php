...
// Raw SCSS setting.
$string['choosereadme'] = 'classic_unitec_tepukenga_dark is a highly-customisable theme, based on Boost, with an alternative navigation layout. This theme is intended to be used directly, or as a parent theme when creating or updating custom themes to utilise Bootstrap 4.';
$string['configtitle'] = 'Classic Unitec TePukenga Dark';
...
$string['pluginname'] = 'Classic Unitec TePukenga Dark';
...
$string['privacy:metadata'] = 'The classic_unitec_tepukenga_dark theme does not store any personal data.';
