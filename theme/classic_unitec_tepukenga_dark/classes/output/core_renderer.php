...
namespace theme_classic_unitec_tepukenga_dark\output;
 ...
 *       which removes the edit button required by classic_unitec_tepukenga_dark.
 *
 * @package    theme_classic_unitec_tepukenga_dark
 * @copyright  2018 Bas Brands
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class core_renderer extends \core_renderer {
 ...
 ######################################################################################*/   
        ...
        if (isloggedin() && $mycourses && $mycourses->has_children()) {
            $branchlabel = get_string('mycourses', 'theme_classic_unitec_tepukenga_dark');
