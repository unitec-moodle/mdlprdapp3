 ...
 *
 * @module     theme_boost_comm_stud/form-display-errors
...
define(['jquery', 'core/event'], function($, Event) {
    return {
        enhance: function(elementid) {
            ...
            if (form && !('boost_comm_studFormErrorsEnhanced' in form.dataset)) {
                ...
                form.dataset.boost_comm_studFormErrorsEnhanced = 1;
            }
        }
    };
});
