 ...
 *
 * @module     theme_boost_soc_prac/form-display-errors
...
define(['jquery', 'core/event'], function($, Event) {
    return {
        enhance: function(elementid) {
            ...
            if (form && !('boost_soc_pracFormErrorsEnhanced' in form.dataset)) {
                ...
                form.dataset.boost_soc_pracFormErrorsEnhanced = 1;
            }
        }
    };
});
