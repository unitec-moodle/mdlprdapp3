...
/**
 * Privacy Subsystem implementation for theme_boost_app_bus.
 *
...
namespace theme_boost_app_bus\privacy;
...
class provider implements
    ...
    public static function export_user_preferences(int $userid) {
        ...
        if (isset($draweropennavpref)) {
            $preferencestring = get_string('privacy:drawernavclosed', 'theme_boost_app_bus');
            if ($draweropennavpref == 'true') {
                $preferencestring = get_string('privacy:drawernavopen', 'theme_boost_app_bus');
            }
