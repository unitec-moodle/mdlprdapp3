...
/**
 * This file contains the unittests for boost_app_bus's scss compilation.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_boost_app_bus_scss_testcase extends advanced_testcase {
    /**
    ...
    public function test_scss_compilation_with_sassc() {
        ...
        $this->assertNotEmpty(
            theme_config::load('boost_app_bus')->get_css_content_debug('scss', null, null)
        );
    }
}
