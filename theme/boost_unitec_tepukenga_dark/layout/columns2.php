...
/**
 * A two column layout for the boost_unitec_tepukenga_dark theme.
 *
...
echo $OUTPUT->render_from_template('theme_boost_unitec_tepukenga_dark/columns2', $templatecontext);
