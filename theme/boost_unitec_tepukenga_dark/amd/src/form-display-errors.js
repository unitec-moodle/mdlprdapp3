 ...
 *
 * @module     theme_boost_unitec_tepukenga_dark/form-display-errors
...
define(['jquery', 'core/event'], function($, Event) {
    return {
        enhance: function(elementid) {
            ...
            if (form && !('boost_unitec_tepukenga_darkFormErrorsEnhanced' in form.dataset)) {
                ...
                form.dataset.boost_unitec_tepukenga_darkFormErrorsEnhanced = 1;
            }
        }
    };
});
