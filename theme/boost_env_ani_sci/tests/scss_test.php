...
/**
 * This file contains the unittests for boost_env_ani_sci's scss compilation.
 *
 ...
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class theme_boost_env_ani_sci_scss_testcase extends advanced_testcase {
    /**
     * Test that boost_env_ani_sci can be compiled using SassC (the defacto implemention).
     */
    public function test_scss_compilation_with_sassc() {
        ...
        $this->assertNotEmpty(
            theme_config::load('boost_env_ani_sci')->get_css_content_debug('scss', null, null)
        );
    }
}
