 ...
 *
 * @module     theme_boost_env_ani_sci/form-display-errors
...
define(['jquery', 'core/event'], function($, Event) {
    return {
        enhance: function(elementid) {
            ...
            if (form && !('boost_env_ani_sciFormErrorsEnhanced' in form.dataset)) {
                ...
                form.dataset.boost_env_ani_sciFormErrorsEnhanced = 1;
            }
        }
    };
});
