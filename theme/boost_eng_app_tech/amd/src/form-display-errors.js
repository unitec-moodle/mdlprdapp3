 ...
 *
 * @module     theme_boost_eng_app_tech/form-display-errors
...
define(['jquery', 'core/event'], function($, Event) {
    return {
        enhance: function(elementid) {
            ...
            if (form && !('boost_eng_app_techFormErrorsEnhanced' in form.dataset)) {
                ...
                form.dataset.boost_eng_app_techFormErrorsEnhanced = 1;
            }
        }
    };
});
