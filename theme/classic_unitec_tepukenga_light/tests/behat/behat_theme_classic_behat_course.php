...
/**
 * Behat course-related step definition overrides for the classic_unitec_tepukenga_light theme.
 *
...
/**
 * Course-related step definition overrides for the classic_unitec_tepukenga_light theme.
 *
 * @package    theme_classic_unitec_tepukenga_light
 * @category   test
 * @copyright  2019 Michael Hawkins
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class behat_theme_classic_unitec_tepukenga_light_behat_course extends behat_course {
