...
/**
 * The columns layout for the classic_unitec_tepukenga_light theme.
 *
...
echo $OUTPUT->render_from_template('theme_classic_unitec_tepukenga_light/columns', $templatecontext);
