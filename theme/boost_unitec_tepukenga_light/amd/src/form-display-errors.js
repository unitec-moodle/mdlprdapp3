 ...
 *
 * @module     theme_boost_unitec_tepukenga_light/form-display-errors
...
define(['jquery', 'core/event'], function($, Event) {
    return {
        enhance: function(elementid) {
            ...
            if (form && !('boost_unitec_tepukenga_lightFormErrorsEnhanced' in form.dataset)) {
                ...
                form.dataset.boost_unitec_tepukenga_lightFormErrorsEnhanced = 1;
            }
        }
    };
});
